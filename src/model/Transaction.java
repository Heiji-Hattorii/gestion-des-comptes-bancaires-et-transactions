...
public class Transaction {
    ...
    private Optional<Compte> compteDestination; 
    ...
    public Transaction(String idTransaction, TypeTransaction typeTransaction, double montant, LocalDateTime date, String motif, Compte compteSource, Compte compteDestination) {
        ...
        this.compteDestination = Optional.ofNullable(compteDestination);
    }
    ...
    public Optional<Compte> getCompteDestination() {
        return compteDestination;
    }

    public void setCompteDestination(Optional<Compte> compteDestination) {
